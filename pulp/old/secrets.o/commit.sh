...
kubectl create secret generic pulp-httpd-certs --from-file=httpd.key --from-file=httpd.crt --from-file=auth-ca.crt --from-file=auth-ca.key
kubectl create secret generic pulp-mongodb-cert --from-file=mongodb.pem
kubectl create secret generic pulp-client-cert --from-file=client.pem --from-file=client.crt --from-file=client.key
popd > /dev/null
kubectl create secret generic pulp-qpiddb --from-file=qpiddb/nss
